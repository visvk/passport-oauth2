...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    if (state) {
      ...
      this.redirect(location.replace('account.fleetlog.com.au', 'account.fleetlog.com.au/#/connect'));
    } else {
      function stored(err, state) {
        ...
        delete parsed.search;
        var location = url.format(parsed);
        self.redirect(location.replace('account.fleetlog.com.au', 'account.fleetlog.com.au/#/connect'));
      }
